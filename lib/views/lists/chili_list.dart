...
class ChiliList extends StatelessWidget {
  const ChiliList({Key? key}) : super(key: key);
            ...
            children: [
              ...
              Expanded(
                child: ListView.builder(
                    itemCount: chiliList.length,
                    itemBuilder: (context, index) {
                      Pathology pItem = chiliList[index];
